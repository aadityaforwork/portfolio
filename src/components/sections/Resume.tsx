  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 py-24 sm:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.button
            className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 bg-size-200 bg-pos-0 text-white font-semibold rounded-2xl transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-purple-500/25 overflow-hidden"
